...
- [POC-VI.md](POC-VI.md) — Como tirar o dado de um disco que vai falhar, sem parar o ambiente (concluída no lab: `volumeServer.evacuate` com o servidor em **modo de manutenção**; **não** marcar o volume `readonly` manualmente — volume de ~4 GB falhou 2/2 com a marcação e funcionou sem ela; inclui procedimento de produção com baseline, execução e validação)
